...
HD_PWD='C:/Users/htara/OneDrive/Desktop/VIVA/SPI/SPI.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi.tcl -notrace
